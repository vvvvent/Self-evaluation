...
## 自我评价总共为三大部分涵盖知识积累（18/20）、作业与随堂测试（20/20）和与授课老师、同学与AI的互动（8/10）。
...
![成功安装](https://raw.githubusercontent.com/vvvvent/Self-evaluation/main/安装软件image.png)
...
![成功连接图](https://raw.githubusercontent.com/vvvvent/Self-evaluation/main/连接数据库image.png)
...
根据题目要求做的ER图：
![ER图](https://raw.githubusercontent.com/vvvvent/Self-evaluation/main/ER图.png)
...
### 总分为三部分之和：18+20+8=46。每一部分的总分按照自己在这门课程中所花费的精力大致占比设置的。
